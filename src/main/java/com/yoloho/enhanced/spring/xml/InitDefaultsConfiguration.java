...
public class InitDefaultsConfiguration implements DeferredImportSelector {
    public static class DefaultsConfiguration implements ImportBeanDefinitionRegistrar {
        ...
        public void registerBeanDefinitions(AnnotationMetadata importingClassMetadata,
            ...
            {
                // placeholder 合并进来
                String[] locations = (String[])importingClassMetadata.getAnnotationAttributes(com.yoloho.enhanced.spring.annotation.InitDefaults.class.getName()).get("propertyLocations");
